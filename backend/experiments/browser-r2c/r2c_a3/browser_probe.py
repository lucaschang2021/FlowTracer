...
def _dynamic_fetch(name: str, url: str, selector: str, expected: str) -> dict[str, object]:
        ...
        json.dumps(
            {
                ...
                "failure": failure,
                "host_gateway_endpoint": {"address": host_gateway_ip, "port": 49273},
