...
**当前阶段：ACQ-1 WP-1（ACQ-1A + H0）— 实现候选审查与运行态补充验收中**
...
| ACQ-1-WP1 | Source Contract、安全内核、预算与运行状态 | Backend | 实现候选审查中（尚未 push/PR） | PM-013、PM-014 | `feat/acq-1a-h0@0e95a569`；Migration、Source API 兼容、lease/stale recovery、Network/Site/Resource Policy、测试与运行态报告 |
