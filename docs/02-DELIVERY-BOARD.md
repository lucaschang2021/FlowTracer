...
| PM-010 | BE-8 稳定化与前端交接基线及准入 | 总控 | 待 Review/合并 | BE-7 | `20-BE8-STABILIZATION-HANDOFF-BASELINE.md`、`21-BE-8-ADMISSION.md`、ADR-020、控制 PR |
| BE-8 | 后端稳定化与前端交接 | Backend | 未准入 | PM-010 控制 PR 合并 | 全量门禁、离线闭环、OpenAPI 冻结、性能/安全基线与前端交接包 |
